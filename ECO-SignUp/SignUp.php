...
<body>
 <form id="regForm" action="handelSignup.php" method ="post">

 <h1> تسجيل جديد - ECO</h1>
...
// }
 ...
 <div class="tab"> بيانات شخصية
   ...
   <p><input placeholder=" الأسم الأخير" oninput="this.className = ''" name="wlastname"></p>
 </div>
 <div class="tab">معلومات الاتصال
 
<p><input placeholder=" (الأسم التجاري) أسم المستخدم " oninput="this.className = ''"    name="wUsername"></p>
   <p><input placeholder="رقم الهاتف" oninput="this.className = ''" name="wPhone"></p>
  </p>
  <!-- <div class="dropdown">
    <button class="btn btn-primary dropdown-toggle " type="button" data-toggle="dropdown">ماهي صفتك ؟
    <span class="caret"></span></button>
    <ul class="dropdown-menu dropdown-menu-right">
      <li><a href="#">  مستخدم مجاني</a></li>
      <li><a href="#"> مستخدم عادي</a></li>
      <li><a href="#"> مستخدم اقتصادي</a></li>
      <li><a href="#"> مستخدم متميز</a></li>
      <li><a href="#">شركة</a></li>
  ...
  <!-- <select name="dis" id="">
  <option value="مستخم مجاني">مستخدم مجاني</option>
  <option value="مستخد عادي">مستخد عادي</option>
  <option value="مستخدم اقتصادي">مستخدم اقتصادي</option>
  <option value="مستخدم متميز">مستخد متميز</option>
  <option value="شركة">شركة</option>
  <option value="مستشفي">مستشقي</option>
...
<!-- <div class="dropdown">
  <button class="btn btn-primary dropdown-toggle " type="button" data-toggle="dropdown">ماهي جنسك ؟
  <span class="caret"></span></button>
  <ul class="dropdown-menu dropdown-menu-right">
    <li><a href="#">  ذكر</a></li>
    <li><a href="#"> أنثى</a></li>
...
<p><input placeholder="الرقم القومي" oninput="this.className = ''" name="registration"></p>
</p>
 </div>
...
function showTab(n) {
 ...
 if (n == (x.length - 1)) {
   document.getElementById("nextBtn").innerHTML = " ECO - انشاء حساب فى ستيبن   ";
 } else {
