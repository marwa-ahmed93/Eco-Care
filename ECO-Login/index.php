...
<body>
    ...
    <div class="main">
        ...
        <div class="container b-container" id="b-container">
            ...
            <form class="form" id="b-form" method="post" action="handellogin.php">
                <h2 class="form_title title">EcoCare تسجيل الدخول فى </h2>
                ...
                <span class="form__span">أو اسخدم حسابك المسجل به </span>
    ...
    if(isset($_SESSION['errors'])){
     ...
     session_unset();
    ?>
                <input class="form__input" name="email" type="email" placeholder="البريد الإلكتروني">
                <input class="form__input" name="password" type="password" placeholder="كلمة السر">
<!--                <a class="form__link">نسيت كلمة السر ؟</a>-->
                 <a href="passwordForm.php" class="form__link ">نسيت كلمة السر ؟</a>
<!--                <button class="form__button button submit">تسجيل دخول</button>-->
                
                 <button type="submit" class="switch__button button switch-btn">تسجيل دخول</button>
<!--                  <a class="btn btn-success" href="../ECO-Login/index.html">تسجيل دخول</a>-->
            </form>
        </div>
        <div class="switch" id="switch-cnt">
            ...
            <div class="switch__container" id="switch-c1">
                <h2 class="switch__title title">! مرحبا بعودتك</h2>
                <p class="switch__description description">! لديك حساب بالفعل </p>
                
<!--                <a class="switch__button button switch-btn" href="../ECO-User/users.php">تسجيل دخول</a>-->
<!--                   <button class="form__button button submit">تسجيل دخول</button>-->
                <button type="submit" class="switch__button button switch-btn">تسجيل دخول</button>
            ...
            <div class="switch__container is-hidden" id="switch-c2">
                <h2 class="switch__title title">! مرحبا بك </h2>
                <p class="switch__description description">! ليس لديك حساب بالفعل</p>
                
<!--                <button class="switch__button button switch-btn">انشاء حساب جديد</button>-->
<!--                 <a href="../ECO -SignUp/SignUp.php" class="btn btn-primary stretched-link">انشاء حساب جديد</a>-->
            
             <button class="switch__button button switch-btn">
             <a class="btn btn-success" href="../ECO-SignUp/SignUp.php">انشاء حساب جديد</a>
             </button>   
            </div>
        </div>
    </div>
