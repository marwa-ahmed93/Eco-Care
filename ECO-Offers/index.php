...
<header>
    ...
    <a href="#" class="logo"><i class="fas fa-star"></i>EcoCare-Offers</a>
...
<section class="home " id="home">
    ...
    <h1>مركز EcoCare للخصومات</h1>
    <p>اتبع نظام بيئي  مجاني وأحصل على خصومات تصل ل 20%</p>
...
<div class="box-container">
    ...
    <div class="box">
        <img src="images/proto4.png"s alt="">
        ...
        <div class="content">
            ...
            <a href="#" class="title">خصومات على مبيدات X</a>
            <p>زيادة الوعي البيئي فى المجتمع من خلال حلول تقنية بسيطة يمكن أن تعزز أسلوب حياة صحي للناس لتحفيزهم على أنفسهم
            </p>
            <div class="info">
...
<div class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <h3>خدمات اضافية</h3>
            <a href="#">تواصل مع اخصائي</a>
            <a href="#">تواصل مع مراكز</a>
            <a href="#">تابع نظام بيئي</a>
            <a href="#">مبيدات</a>
        </div>
        ...
        <div class="box">
            ...
            <p> <i class="fas fa-map-marker-alt"></i> الحي السادس , مدينة نصر</p>
            <p> <i class="fas fa-envelope"></i> wkader99@gmail.com </p>
            <p> <i class="fas fa-phone"></i> 01024453417 </p>
        </div>

    </div>

    <h1 class="credit"> جميع حقوق النشر محفوظة <a href="#"> -EcoCare- </a>Mohammed Osman 2020 </h1>
