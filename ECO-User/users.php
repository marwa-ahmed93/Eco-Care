...
<body>
    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="#skills"><i class="bx bx-book-content"></i> مهاراتي </a></li>
          <li><a href="#services"><i class="bx bx-server"></i> الخدمات المتاحة</a></li>
          <li><a href="#testimonials"><i class="bx bx-pencil"></i>تقييم الأستشاريين</a></li>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              <div class="address">
                ...
                <h4>:الموقع</h4>
                <p>الحي السادس - مدينة نصر - مصر</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4> : البريدالإلكتروني</h4>
                <p>wkader99@gmail.com</p>
              </div>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; جميع حقوق النشر محفوظة <strong><span>ECO</span></strong>
      </div>
      <div class="credits">
        2022 <a href="#">Mohammed Osman</a>
      </div>
    </div>
  </footer><!-- End  Footer -->
